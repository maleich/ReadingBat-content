...
Current version: **1.2.0** — see [CHANGELOG.md](CHANGELOG.md) and
...
Ktor 3.6.0, readingbat-core 3.4.0, Kotest 6.2.5, core-utils 3.2.2,
kotlinter 5.7.0, detekt 2.0.0-alpha.6, Gradle 9.7.1.
